...
a = Analysis(['main.py',
              ...
              'imports.py'],
             pathex=['C:\\Users\\andre\\Documents\\GitHub\\ARM-ML-Embedded'],
             binaries=[],
             datas=[('scripts','scripts'),
                    ('Images','Images'),
                    ('arduino_inference_script','arduino_inference_script'),
                    ('arduino_record_script','arduino_record_script'),
                    ('C:\\Users\\andre\\AppData\\Local\\Programs\\Python\\Python39\\Lib\\site-packages\\librosa\\util\\example_data','librosa/util/example_data/')],
             hiddenimports=[],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
